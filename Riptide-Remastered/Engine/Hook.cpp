...
//																																				//
//																																				//
//  Riptide coded by Baseult https://pasters.cc/User-Baseul and Updated by vsonyp0wer															//
//																																				//
//																																			    //
//																																			    //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if (d3d9TablePtrPtr && dwPresent_o)
			{
				...
				if (IDirect3DDevice9Table.InitTable(g_pDevice))
				{
					...
					*dwAddress = (DWORD_PTR)(&Hook_Present);
					...
					//------------------------------------------------SKINCHANGER / RAGEBOT------------------------------------------------------------
									/*	if ( !ClientTable.InitTable( Interfaces::Client() ) )			//Antipasta fix me
											return false;
