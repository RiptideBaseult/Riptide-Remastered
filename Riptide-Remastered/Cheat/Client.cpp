...
//																																				//
//																																				//
//										Riptide Official coded by Baseult https://pasters.cc/User-Baseult										//
//																																				//
//												Further Updates on https://riptide.tk														    //
//																																			    //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void OnRender()
	{
		...
		if (g_pRender && Interfaces::Engine()->IsActiveApp())
		{
			...
			if (Settings::Esp::esp_Watermark)
			{
				...
				if (u > 1700 && u <= 2300)    g_pRender->Text(15, 15, false, true, Color::FromHSB(rainbow, 1.f, 1.f), "by Baseult");
				if (u > 2300 && u <= 2400)    g_pRender->Text(15, 15, false, true, Color::FromHSB(rainbow, 1.f, 1.f), "");
			...
			if (tabSelected == 0) // Rage
			{
				...
				ImGui::BeginChild(1, ImVec2(-1, 680), true);
				{
					...
					if (otherpages == 1)
					{
						...
						/*ImGui::Checkbox("Draw Spread", &Settings::Misc::ShowSpread);				//Disabled (Fix Framestage and it should work)
						if (ImGui::IsItemHovered())
						...
						//Disabled (Doesn't work without Framestage. Fix Framestage and it works again.)
...
/*
						...
						*/
						...
						ImGui::Text("Advanced Ragebot Features Disabled");
						ImGui::Text("Fix Framestage for Multipoints and Hitscan");
						ImGui::Text("Updates Coming Soon");
			...
			else if (tabSelected == 3) // Skins
			{
				...
				ImGui::BeginChild(1, ImVec2(-1, 680), true);
				{
					...
					/*ImGui::Checkbox("Skinchanger", &Settings::Misc::misc_SkinChanger);			//DISABLED - FIX FRAMESTAGE AND IT WORKS AGAIN!
					if (ImGui::IsItemHovered())
					...
					ImGui::Spacing();
					ImGui::Text("Skinchanger Disabled - Update Soon");
					ImGui::Text("Fix Framestage for Skinchanger");
					ImGui::Spacing();
					ImGui::Separator();
					ImGui::Spacing();
			...
			else if (tabSelected == 4) // Misc
			{
				...
				ImGui::BeginChild(1, ImVec2(-1, 680), true);
				{
					...
					if (otherpages == 0)
					{
						...
						ImGui::Text("Riptide Coded by Baseult, Swifty, Mitch, vsonyp0wer, Karmafreediet");
